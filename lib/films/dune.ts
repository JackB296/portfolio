import { asset, defineExperience, effect, music } from "./builders";
...
const dune: FilmDefinition = {
  ...
  experience: defineExperience({
    ...
    markers: ["ground pulse", "twin moons", "water allocation", "ornithopter", "spice blow", "spice glints"],
    motion: "pulse",
    radius: "1px",
    audio: {
  ...
  credits: {
    pixabayMusic: { title: "Church choir", creator: "poshpony", href: "https://pixabay.com/music/choir-church-choir-297898/" },
  },
};
